document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('https://api.ipify.org?format=json')
        ...
        .then(data => {
            ...
            // Llamar al servidor Flask a través del túnel para guardar la IP
...
// Función para guardar la IP en el servidor Flask a través del túnel
function saveIpToServer(ip, timestamp) {
    fetch('http://properties-pork.gl.at.ply.gg:23101/save_ip', { // Aquí está el cambio de URL
        method: 'POST',
        headers: {
